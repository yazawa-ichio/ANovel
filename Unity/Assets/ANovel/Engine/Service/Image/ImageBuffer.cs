...
namespace ANovel.Service
{
	public class ImageBuffer
	{
		...
		ImageController m_Current;
		ImageController m_Prev;
		IScreenService Screen => m_Container.Get<IScreenService>();

		public ImageBuffer(ServiceContainer container)
		{
		...
		public IPlayHandle Show(ImageObjectConfig config, LayoutConfig layout)
		{
			if (m_Current == null)
			{
				m_Current = new ImageController(m_Container, Screen.CurrentId);
			}
